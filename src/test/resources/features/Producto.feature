...
Feature: Búsqueda de productos en MarketPlace
  ...
  Background:
    # Este Given se ejecuta AUTOMÁTICAMENTE antes de cada Scenario de
    # este archivo — por eso ningún TC de abajo lo repite.
  ...
  @TC-7
  # "Scenario Outline" en vez de "Scenario": esto ejecuta el MISMO
  # bloque de pasos una vez POR CADA fila de la tabla Examples de abajo.
